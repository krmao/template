 ...
 * “图片、颜色、文字”
 */
class HKTitleBar(val mContext: Context, attrs: AttributeSet?) : RelativeLayout(mContext, attrs) {
    ...
    init {
        LayoutInflater.from(mContext).inflate(R.layout.hk_widget_titlebar, this, true)

        val iconPadding = resources.getDimensionPixelSize(R.dimen.hk_titlebar_icon_padding)

        if (attrs != null) {
            val typedArray = mContext.obtainStyledAttributes(attrs, R.styleable.HKTitleBar)
            setBackground(this, R.styleable.HKTitleBar_android_background, DEFAULT_BACKGROUND_COLOR, -1, typedArray)

            //title
            setText(titleText, R.styleable.HKTitleBar_hkTitleText, null, typedArray)
            setTextColor(titleText, R.styleable.HKTitleBar_hkTitleTxtColor, DEFAULT_TEXT_COLOR, typedArray)
            setTextSize(titleText, R.styleable.HKTitleBar_hkTitleSize, DEFAULT_TEXT_SIZE, typedArray)
            setTextAppearance(titleText, R.styleable.HKTitleBar_hkTitleAppearance, typedArray)
            //left0
            setBackground(left0BgView, R.styleable.HKTitleBar_hkLeft0BgViewBackground, -1, R.drawable.hk_selector, typedArray)
            setLayoutParams(left0BgView, left0Btn, R.styleable.HKTitleBar_hkLeft0BgWidth, typedArray)
            setBgPadding(left0BgView, R.styleable.HKTitleBar_hkLeft0BgViewPadding, R.styleable.HKTitleBar_hkLeft0BgPaddingLeft, R.styleable.HKTitleBar_hkLeft0BgPaddingRight, R.styleable.HKTitleBar_hkLeft0BgPaddingTop, R.styleable.HKTitleBar_hkLeft0BgPaddingBottom, iconPadding, typedArray)
            ...
            //left1
            setBackground(left1BgView, R.styleable.HKTitleBar_hkLeft1BgViewBackground, -1, R.drawable.hk_selector, typedArray)
            setLayoutParams(left1BgView, left1Btn, R.styleable.HKTitleBar_hkLeft1BgWidth, typedArray)
            ...
            //right0
            setBackground(right0BgView, R.styleable.HKTitleBar_hkRight0BgViewBackground, -1, R.drawable.hk_selector, typedArray)
            setLayoutParams(right0BgView, right0Btn, R.styleable.HKTitleBar_hkRight0BgWidth, typedArray)
            ...
            //right1
            setBackground(right1BgView, R.styleable.HKTitleBar_hkRight1BgViewBackground, -1, R.drawable.hk_selector, typedArray)
            setLayoutParams(right1BgView, right1Btn, R.styleable.HKTitleBar_hkRight1BgWidth, typedArray)
