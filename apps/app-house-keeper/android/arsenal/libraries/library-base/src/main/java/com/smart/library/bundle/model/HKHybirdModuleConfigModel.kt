...
data class HKHybirdModuleConfigModel(
    ...
    override fun equals(other: Any?): Boolean = other is HKHybirdModuleConfigModel && moduleVersion == other.moduleVersion && moduleName == other.moduleName
    ...
    companion object {
        @JvmStatic
        val invalidConfigModel: HKHybirdModuleConfigModel = HKHybirdModuleConfigModel()
    }
}
