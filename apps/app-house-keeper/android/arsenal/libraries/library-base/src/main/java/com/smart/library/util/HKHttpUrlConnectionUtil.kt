...
object HKHttpUrlConnectionUtil {
    ...
    fun post(httpUrl: String, params: Map<String, String>, files: Map<String, File>?): String {
        ...
        HKLogUtil.d(TAG, "responseCode:" + responseCode)
        HKLogUtil.d(TAG, "responseMessage:" + conn.responseMessage)
        outStream.close()
        conn.disconnect()
    ...
    operator fun get(httpUrl: String): String {
        ...
        try {
            ...
            HKLogUtil.d(TAG, "responseContent:" + content.toByteArray(charset("utf-8")))
        } catch (e: Exception) {
            e.printStackTrace()
        }
