...
class HKHybirdMethods {
     ...
     */
    companion object {
        fun showToast(message: String) = HKToastUtil.show(message)
        ...
        fun putToMemory(module: String, key: String, value: String) = HKCacheManager.put(module, key, value)

        fun getFromMemory(module: String, key: String, default: String? = null): String? = HKCacheManager.get(module, key, default)

        fun removeFromMemory(module: String) = HKCacheManager.remove(module)

        fun removeFromMemory(module: String, key: String) = HKCacheManager.remove(module, key)
