 ...
 */
@Suppress("unused")
class HKRoundImageView : AppCompatImageView {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyle: Int) : super(context, attrs, defStyle) {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.HKRoundImageView, defStyle, 0)
        type = typedArray.getInt(R.styleable.HKRoundImageView_hkType, type)
        mBorderColor = typedArray.getColor(R.styleable.HKRoundImageView_hkBorderColor, mBorderColor)
        mBorderWidth = typedArray.getDimension(R.styleable.HKRoundImageView_hkBorderWidth, mBorderWidth)
        mCornerRadius = typedArray.getDimension(R.styleable.HKRoundImageView_hkCornerRadius, mCornerRadius)
        mLeftTopCornerRadius = typedArray.getDimension(R.styleable.HKRoundImageView_hkLeftTopCornerRadius, mLeftTopCornerRadius)
        mLeftBottomCornerRadius = typedArray.getDimension(R.styleable.HKRoundImageView_hkLeftBottomCornerRadius, mLeftBottomCornerRadius)
        mRightTopCornerRadius = typedArray.getDimension(R.styleable.HKRoundImageView_hkRightTopCornerRadius, mRightTopCornerRadius)
        mRightBottomCornerRadius = typedArray.getDimension(R.styleable.HKRoundImageView_hkRightBottomCornerRadius, mRightBottomCornerRadius)
        mProgressColor = typedArray.getColor(R.styleable.HKRoundImageView_hkProgressColor, mProgressColor)
        mBorderProgress = typedArray.getInteger(R.styleable.HKRoundImageView_hkProgressBorder, mBorderProgress)
        typedArray.recycle()
    }
     ...
     * 默认为圆形图片
     */
    fun setType(imageType: Int): HKRoundImageView {
     ...
     * 设置圆角图片的圆角大小
     */
    fun setCornerRadius(cornerRadius: Int): HKRoundImageView {
     ...
     * 设置圆角图片的左上圆角大小
     */
    fun setLeftTopCornerRadius(cornerRadius: Int): HKRoundImageView {
        val radius = dp2px(cornerRadius)
     ...
     * 设置圆角图片的右上圆角大小
     */
    fun setRightTopCornerRadius(cornerRadius: Int): HKRoundImageView {
        val radius = dp2px(cornerRadius)
     ...
     * 设置圆角图片的左下圆角大小
     */
    fun setLeftBottomCornerRadius(cornerRadius: Int): HKRoundImageView {
        val radius = dp2px(cornerRadius)
     ...
     * 设置圆角图片的右下圆角大小
     */
    fun setRightBottomCornerRadius(cornerRadius: Int): HKRoundImageView {
        val radius = dp2px(cornerRadius)
     ...
     * 设置描边宽度
     */
    fun setBorderWidth(borderWidth: Int): HKRoundImageView {
     ...
     * 设置描边颜色
     */
    fun setBorderColor(borderColor: Int): HKRoundImageView {
