...
class HKLoadMoreWrapper(private val mContext: Context, private val innerAdapter: RecyclerView.Adapter<RecyclerView.ViewHolder>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    private fun wrapperFullSpan(holder: HKRecyclerViewAdapter.ViewHolder): HKRecyclerViewAdapter.ViewHolder {
    ...
    private val loadMoreViewHolder: HKRecyclerViewAdapter.ViewHolder
        get() {
            ...
            return wrapperFullSpan(HKRecyclerViewAdapter.ViewHolder(mLoadMoreView))
        }

    private val loadFailedViewHolder: HKRecyclerViewAdapter.ViewHolder
        get() {
            ...
            return wrapperFullSpan(HKRecyclerViewAdapter.ViewHolder(mLoadMoreFailedView))
        }


    private val noMoreViewHolder: HKRecyclerViewAdapter.ViewHolder
        get() {
            if (mNoMoreView == null) {
            ...
            return wrapperFullSpan(HKRecyclerViewAdapter.ViewHolder(mNoMoreView))
        }
    ...
    fun setOnLoadListener(onLoadListener: OnLoadListener): HKLoadMoreWrapper {
