...
interface HKApi {
    ...
    @GET
    fun downloadHybirdModuleConfiguration(@Url url: String): Observable<HKHybirdModuleConfigModel>

    @GET
    fun downloadHybirdAllModuleConfigurations(@Url url: String): Observable<MutableList<HKHybirdModuleConfigModel>>
