...
class HKOkHttpProgressResponseBody(private var requestUrl: String? = null, private val responseBody: ResponseBody, private val onProgress: ((url: String, current: Long, total: Long) -> Unit?)? = null) : ResponseBody() {
