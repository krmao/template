...
class CXRecyclerViewTransferManager(val fromRecyclerView: RecyclerView, val toRecyclerView: RecyclerView, val onFromRecyclerViewEnding: (fromRecyclerView: RecyclerView, fromPosition: Int) -> Unit, val onToRecyclerViewDropping: (toRecyclerView: RecyclerView, fromPosition: Int, toPosition: Int) -> Unit) {
        ...
        toRecyclerView.setOnDragListener { dragView, dragEvent ->
            ...
            when (dragEvent.action) {
                ...
                DragEvent.ACTION_DRAG_LOCATION -> {
                    ...
                    CXLogUtil.d(TAG, "days ACTION_DRAG_LOCATION $dataNewPosition")
                }
