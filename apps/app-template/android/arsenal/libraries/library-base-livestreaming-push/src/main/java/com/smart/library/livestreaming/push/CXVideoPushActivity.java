...
public class CXVideoPushActivity extends AppCompatActivity implements RtmpHandler.RtmpListener,
        SrsRecordHandler.SrsRecordListener, SrsEncodeHandler.SrsEncodeListener {

    private static final String TAG = "Yasea";

    public static Intent newIntent(Context context, String rtmpPath) {
        Intent intent = new Intent(context, CXVideoPushActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cx_activity_video_push);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.cx_menu_push, menu);
        return true;
    }
