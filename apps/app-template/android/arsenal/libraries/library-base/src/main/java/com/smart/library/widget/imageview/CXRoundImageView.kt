...
class CXRoundImageView : AppCompatImageView {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyle: Int) : super(context, attrs, defStyle) {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.CXRoundImageView, defStyle, 0)
        type = typedArray.getInt(R.styleable.CXRoundImageView_cxType, type)
        mBorderColor = typedArray.getColor(R.styleable.CXRoundImageView_cxBorderColor, mBorderColor)
        mBorderWidth = typedArray.getDimension(R.styleable.CXRoundImageView_cxBorderWidth, mBorderWidth)
        mCornerRadius = typedArray.getDimension(R.styleable.CXRoundImageView_cxCornerRadius, mCornerRadius)
        mLeftTopCornerRadius = typedArray.getDimension(R.styleable.CXRoundImageView_cxLeftTopCornerRadius, mLeftTopCornerRadius)
        mLeftBottomCornerRadius = typedArray.getDimension(R.styleable.CXRoundImageView_cxLeftBottomCornerRadius, mLeftBottomCornerRadius)
        mRightTopCornerRadius = typedArray.getDimension(R.styleable.CXRoundImageView_cxRightTopCornerRadius, mRightTopCornerRadius)
        mRightBottomCornerRadius = typedArray.getDimension(R.styleable.CXRoundImageView_cxRightBottomCornerRadius, mRightBottomCornerRadius)
        mProgressColor = typedArray.getColor(R.styleable.CXRoundImageView_cxProgressColor, mProgressColor)
        mBorderProgress = typedArray.getInteger(R.styleable.CXRoundImageView_cxProgressBorder, mBorderProgress)
        typedArray.recycle()
    }
     ...
     * 默认为圆形图片
     */
    fun setType(imageType: Int): CXRoundImageView {
     ...
     * 设置圆角图片的圆角大小
     */
    fun setCornerRadius(cornerRadius: Int): CXRoundImageView {
     ...
     * 设置圆角图片的左上圆角大小
     */
    fun setLeftTopCornerRadius(cornerRadius: Int): CXRoundImageView {
        val radius = dp2px(cornerRadius)
     ...
     * 设置圆角图片的右上圆角大小
     */
    fun setRightTopCornerRadius(cornerRadius: Int): CXRoundImageView {
        val radius = dp2px(cornerRadius)
     ...
     * 设置圆角图片的左下圆角大小
     */
    fun setLeftBottomCornerRadius(cornerRadius: Int): CXRoundImageView {
        val radius = dp2px(cornerRadius)
     ...
     * 设置圆角图片的右下圆角大小
     */
    fun setRightBottomCornerRadius(cornerRadius: Int): CXRoundImageView {
        val radius = dp2px(cornerRadius)
     ...
     * 设置描边宽度
     */
    fun setBorderWidth(borderWidth: Int): CXRoundImageView {
     ...
     * 设置描边颜色
     */
    fun setBorderColor(borderColor: Int): CXRoundImageView {
