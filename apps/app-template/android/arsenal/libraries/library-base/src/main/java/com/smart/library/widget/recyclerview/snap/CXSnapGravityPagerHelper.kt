...
@Suppress("unused")
class CXSnapGravityPagerHelper @JvmOverloads constructor(gravity: Int, enableSnapLastItem: Boolean = false, snapListener: CXSnapGravityHelper.SnapListener? = null) : PagerSnapHelper() {

    private val delegate: CXSnapGravityHelper.GSSnapGravityDelegate = CXSnapGravityHelper.GSSnapGravityDelegate(gravity, enableSnapLastItem, snapListener)
