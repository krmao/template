...
class _TitleBarWidgetState extends State<TitleBarWidget> {
    ...
    Widget build(BuildContext context) {
        return Container(
            ...
            child: Stack(
                children: <Widget>[
                    widget.disableBack ? Container() : Align(
                    ...
                    (widget.title == null || widget.title.length <= 0) ? Container() : Align(
                    ...
                    (widget.rightText == null || widget.rightText.length <= 0) ? Container() : Align(
