...
import {AppRegistry, DeviceEventEmitter, Dimensions, Image, NativeModules, ScrollView, StatusBar, StyleSheet, Text, TextInput, ToastAndroid, TouchableOpacity, View} from "react-native";
        ...
        return (
            <View style={styles.root}>
                ...
                <View style={styles.content}>
                    ...
                    <View style={{backgroundColor: "#afafaf", height: 1}}/>
                    <ScrollView>
                        ...
                        <View style={styles.description}>
                            ...
                            <Text style={{fontSize: 19, lineHeight: 21, color: "#fc5430", marginTop: 18}}>¥80.00</Text>
                ...
                <View>
                    ...
                    <View style={{flexDirection: "row", backgroundColor: "#fff", alignItems: "center", justifyContent: "center"}}>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => {
                                ToastAndroid.show("立即预约", ToastAndroid.SHORT)
                            }}>
