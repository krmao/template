...
/**
 事件对象:负责众多订阅者的派发处理等
 */
@class STEventSubscribeModel,STEventUserInfo;
...
/**
 ...
 @param target key
 */
- (void)registSubscribModel:(STEventSubscribeModel *_Nonnull)subscrib forKey:(id _Nonnull )target;
/**
 触发具体事件，执行其队列中的订阅者行为
 ...
 */
- (void)postEventWithDeliveryData:(STEventUserInfo *_Nonnull )info isInMain:(BOOL)isMain;
/**
