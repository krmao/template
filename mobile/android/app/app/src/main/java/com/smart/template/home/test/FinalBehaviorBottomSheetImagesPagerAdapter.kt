...
class FinalBehaviorBottomSheetImagesPagerAdapter(context: Context) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        val itemView = layoutInflater.inflate(R.layout.final_behavior_pager_item, container, false)
