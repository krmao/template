...
import com.smart.library.widget.STMagicView
import com.smart.template.R
import kotlinx.android.synthetic.main.final_magic_fragment.*

@Suppress("unused", "DEPRECATION")
class FinalMagicFragment : STBaseFragment() {

    private val bitmap: Bitmap by lazy { BitmapFactory.decodeResource(resources, R.drawable.final_beauty) }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        return inflater.inflate(R.layout.final_magic_fragment, container, false)
    }
