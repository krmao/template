...
class RecyclerViewDragAndTransferFragment : STBaseFragment() {

    companion object {
        fun goTo(context: Context?) {
            STActivity.start(context, RecyclerViewDragAndTransferFragment::class.java)
        }
    }
    ...
    private val daysAdapter by lazy {
        object : STRecyclerViewAdapter<String, STRecyclerViewAdapter.ViewHolder>(context, daysList) {
            override fun onCreateViewHolder(container: ViewGroup, position: Int): ViewHolder {
                return STRecyclerViewAdapter.ViewHolder(LayoutInflater.from(context).inflate(R.layout.home_fragment_recycler_view_drag_and_transfer_item_days, container, false))
            }
    ...
    private val dayDetailAdapter by lazy {
        object : STRecyclerViewAdapter<String, STRecyclerViewAdapter.ViewHolder>(context, dayDetailList) {
            override fun onCreateViewHolder(container: ViewGroup, position: Int): ViewHolder {
                return STRecyclerViewAdapter.ViewHolder(LayoutInflater.from(context).inflate(R.layout.home_fragment_recycler_view_drag_and_transfer_item_day_detail, container, false))
            }
    ...
    private var recyclerViewTransferManager: STRecyclerViewTransferManager? = null
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerViewTransferManager = STRecyclerViewTransferManager(recyclerViewDayDetail, recyclerViewDays, { _: RecyclerView, fromPosition: Int ->
