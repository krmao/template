...
class STRecyclerViewTransferManager(val fromRecyclerView: RecyclerView, val toRecyclerView: RecyclerView, val onFromRecyclerViewEnding: (fromRecyclerView: RecyclerView, fromPosition: Int) -> Unit, val onToRecyclerViewDropping: (toRecyclerView: RecyclerView, fromPosition: Int, toPosition: Int) -> Unit) {
