...
public class FinalBottomSheetBehaviorGoogleMapsLike<V extends View> extends CoordinatorLayout.Behavior<V> {
     ...
     */
    public FinalBottomSheetBehaviorGoogleMapsLike() {
    }
     ...
     */
    public FinalBottomSheetBehaviorGoogleMapsLike(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mCollapsible = true;
        a = context.obtainStyledAttributes(attrs, R.styleable.FinalCustomBottomSheetBehavior);
        if (attrs != null) {
            mAnchorPoint = (int) a.getDimension(R.styleable.FinalCustomBottomSheetBehavior_finalAnchorPoint, 0);
            mState = a.getInt(R.styleable.FinalCustomBottomSheetBehavior_finalDefaultBehaviorState, STATE_ANCHOR_POINT);
        }
        a.recycle();
...
//            mCallback.onStateChanged(bottomSheet, state);
    ...
    /**
     * A utility function to get the {@link FinalBottomSheetBehaviorGoogleMapsLike} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link FinalBottomSheetBehaviorGoogleMapsLike}.
     * @param <V>  Instance of behavior
     * @return The {@link FinalBottomSheetBehaviorGoogleMapsLike} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> FinalBottomSheetBehaviorGoogleMapsLike<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof FinalBottomSheetBehaviorGoogleMapsLike)) {
            throw new IllegalArgumentException(
                    "The view is not associated with BottomSheetBehaviorGoogleMapsLike");
        }
        return (FinalBottomSheetBehaviorGoogleMapsLike<V>) behavior;
    }
