 ...
 * already in FAB.
 */
public class FinalScrollAwareFABBehavior extends FloatingActionButton.Behavior {
    ...
    /**
     * The FAB should be hidden when it reach {@link #offset} or when {@link FinalBottomSheetBehaviorGoogleMapsLike}
     * is visually lower than {@link FinalBottomSheetBehaviorGoogleMapsLike#getPeekHeight()}.
    ...
    public FinalScrollAwareFABBehavior(Context context, AttributeSet attrs) {
        super();
        offset = 0;
...
//         Ensure we react to vertical scrolling
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, FloatingActionButton child, View dependency) {
        ...
        if ((child.getY() + DyFix) < offset)
            ...
            /**
             * We are calculating every time point in Y where BottomSheet get {@link FinalBottomSheetBehaviorGoogleMapsLike#STATE_COLLAPSED}.
    ...
    private void setOffsetValue(CoordinatorLayout coordinatorLayout) {
        ...
        for (int i = 0; i < coordinatorLayout.getChildCount(); i++) {
            ...
            if (child instanceof FinalMergedAppBarLayout) {
