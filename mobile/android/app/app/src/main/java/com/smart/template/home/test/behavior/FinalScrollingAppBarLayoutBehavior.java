 ...
 *
 */
public class FinalScrollingAppBarLayoutBehavior extends AppBarLayout.ScrollingViewBehavior {

    private static final String TAG = FinalScrollingAppBarLayoutBehavior.class.getSimpleName();
    ...
    public FinalScrollingAppBarLayoutBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }
    ...
    private boolean init(CoordinatorLayout parent, View child, View dependency) {
         ...
         * {@link FinalBottomSheetBehaviorGoogleMapsLike#getPeekHeight()} Y position to know if need to show the AppBar at beginning.
         */
        getBottomSheetBehavior(parent);
        if (mBottomSheetBehaviorRef == null || mBottomSheetBehaviorRef.get() == null)
            getBottomSheetBehavior(parent);
