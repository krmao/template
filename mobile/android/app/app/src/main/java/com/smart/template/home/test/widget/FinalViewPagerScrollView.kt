...
class FinalViewPagerScrollView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : FrameLayout(context, attrs, defStyleAttr) {
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.final_scroll_view_pager, this)
        viewPager.pageMargin = STSystemUtil.getPxFromDp(30f).toInt()
        viewPager.offscreenPageLimit = 10
        viewPager.adapter = FinalViewPagerAdapter(context, this)
    ...
    fun getCurrentRecyclerView(): FinalRecyclerView {
