...
open class STActivity : STBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        try {
            ...
            Log.e(STActivity::javaClass.name, "Has error in new instance of fragment", e)
        }
    }

    override fun onStart() {
        Log.w("STActivity", "onStart:$taskId")
        super.onStart()
    }

    override fun onRestart() {
        super.onRestart()
        Log.w("STActivity", "onRestart:$taskId")
    }

    override fun onResume() {
        super.onResume()
        Log.w("STActivity", "onResume:$taskId")
    }

    override fun onPause() {
        super.onPause()
        Log.w("STActivity", "onPause:$taskId")
    }

    override fun onStop() {
        super.onStop()
        Log.w("STActivity", "onStop:$taskId")
    }
}
