...
open class STTransparentActivity : STBaseActivity() {
    ...
    companion object {
        ...
        fun getIntent(context: Context?, themResId: Int, fragmentClassName: String?, args: Bundle = Bundle()): Intent {
            val intent = Intent(context, STTransparentActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        try {
            ...
            if (fragmentObject is Class<*>) {
                ...
                try {
                    ...
                    /*try {
                        ...
                        STLogUtil.e("ClassNotFoundException:$fragmentClassName", e)
                    }*/
                }
            }
            if (fragment != null) {
            ...
            Log.e(STTransparentActivity::javaClass.name, "Has error in new instance of fragment", e)
        }
    }

    override fun onStart() {
        Log.w("STTransparentActivity", "onStart:$taskId")
        super.onStart()
    }

    override fun onRestart() {
        super.onRestart()
        Log.w("STTransparentActivity", "onRestart:$taskId")
    }

    override fun onResume() {
        super.onResume()
        Log.w("STTransparentActivity", "onResume:$taskId")
    }

    override fun onPause() {
        super.onPause()
        Log.w("STTransparentActivity", "onPause:$taskId")
    }

    override fun onStop() {
        super.onStop()
        Log.w("STTransparentActivity", "onStop:$taskId")
    }
}
