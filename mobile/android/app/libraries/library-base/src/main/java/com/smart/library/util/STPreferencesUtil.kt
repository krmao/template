...
object STPreferencesUtil {
    ...
    private var mSharedPreferences: SharedPreferences = STBaseApplication.INSTANCE.getSharedPreferences(STConfig.NAME_SHARED_PREFERENCES, Context.MODE_PRIVATE)
