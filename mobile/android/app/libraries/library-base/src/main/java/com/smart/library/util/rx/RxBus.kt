 ...
 *
 *      compositeDisposable.add(RxBus.toObservable(STApplicationVisibleChangedEvent::class.java).subscribe { changeEvent ->
 *          if (changeEvent.isApplicationVisible)
 *              STDebugFragment.showDebugNotification(notificationId)
 *          else
 *              STDebugFragment.cancelDebugNotification(notificationId)
 *      })
 *
