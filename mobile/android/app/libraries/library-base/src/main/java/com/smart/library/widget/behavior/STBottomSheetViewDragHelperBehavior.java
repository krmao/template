...
public class STBottomSheetViewDragHelperBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    int state;
    public STBottomSheetViewDragHelper viewDragHelper;
    ...
    public STBottomSheetViewDragHelper.Callback dragCallback;

    public STBottomSheetViewDragHelperBehavior() {
        this.fitToContents = true;
        this.state = 4;
        this.dragCallback = new STBottomSheetViewDragHelper.Callback() {
    ...
    public STBottomSheetViewDragHelperBehavior(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        this.fitToContents = true;
        this.state = 4;
        this.dragCallback = new STBottomSheetViewDragHelper.Callback() {
    ...
    public boolean onLayoutChild(final CoordinatorLayout parent, final V child, final int layoutDirection) {
        ...
        if (this.viewDragHelper == null) {
            this.viewDragHelper = STBottomSheetViewDragHelper.create((ViewGroup) parent, this.dragCallback);
        }
    ...
    public static <V extends View> STBottomSheetViewDragHelperBehavior<V> from(final V view) {
        ...
        if (!(behavior instanceof STBottomSheetViewDragHelperBehavior)) {
            throw new IllegalArgumentException("The view is not associated with STBottomSheetViewDragHelperBehavior");
        }
        return (STBottomSheetViewDragHelperBehavior<V>) behavior;
    }
