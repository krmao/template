...
open class STFlutterActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun startNewTask(fragmentClass: Class<*>, args: Bundle = Bundle()) =
                STFlutterInitializer.application?.startActivity(getNewTaskIntent(STFlutterInitializer.application, fragmentClass, args))

        @JvmOverloads
        @JvmStatic
        fun startSingleTask(from: Context?, fragmentClass: Class<*>, args: Bundle = Bundle()) =
                STFlutterInitializer.application?.startActivity(getSingleTaskIntent(from, 0, fragmentClass, args))
        ...
        fun getIntent(context: Context?, themResId: Int, fragmentClassName: String?, args: Bundle = Bundle()): Intent? {
            ...
            val intent = Intent(context, STFlutterActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        try {
            ...
            Log.e(STFlutterActivity::javaClass.name, "Has error in new instance of fragment", e)
        }
    }
