...
@Suppress("unused")
class STFlutterFragment : BoostFlutterFragment() {
    ...
    companion object {
        ...
        fun startForResult(activity: Activity?, containerName: String, containerParams: MutableMap<String, Any>? = hashMapOf(), requestCode: Int = 0) {
            STFlutterActivity.startForResult(activity, requestCode, STFlutterFragment::class.java, createArguments(containerName, containerParams))
        }
        ...
        fun startForResult(fragment: Fragment?, containerName: String, containerParams: MutableMap<String, Any>? = hashMapOf(), requestCode: Int = 0) {
            STFlutterActivity.startForResult(fragment, requestCode, STFlutterFragment::class.java, createArguments(containerName, containerParams))
        }

        @JvmStatic
        @JvmOverloads
        fun createFragment(containerName: String, containerParams: MutableMap<String, Any>? = hashMapOf()): STFlutterFragment {
            val fragment = STFlutterFragment()
