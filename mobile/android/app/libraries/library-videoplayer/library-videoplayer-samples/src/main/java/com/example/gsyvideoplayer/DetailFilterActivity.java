...
public class DetailFilterActivity extends GSYBaseActivityDetail<StandardGSYVideoPlayer> {
    ...
    @BindView(R2.id.activity_detail_player)
    RelativeLayout activityDetailPlayer;

    @BindView(R2.id.change_filter)
    Button changeFilter;
    ...
    @BindView(R2.id.change_anima)
    Button anima;

    @BindView(R2.id.start_gif)
    Button startGif;

    @BindView(R2.id.stop_gif)
    Button stopGif;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jump.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //startActivity(new Intent(DetailControlActivity.this, MainActivity222.class));
