...
interface STApi {
     ...
     * 上传, 例:
     *
     *      STApiManager.getApi(STApi.class)
     *              .upload(url, STApi.Companion.createBody(file, new ProgressListener() {...}))
     *              .subscribe(...);
     *
     ...
     */
    @POST
    fun upload(@Url url: String, @Body body: RequestBody): Observable<STResponseModel<Any>>
