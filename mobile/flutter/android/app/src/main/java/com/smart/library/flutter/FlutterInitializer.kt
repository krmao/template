        ...
        FlutterBoost.init(
                object : Platform() {
                    ...
                    override fun closeContainer(containerRecord: IContainerRecord?, result: MutableMap<String, Any>?, exts: MutableMap<String, Any>?) {
                        Log.d("closeContainer", "--> closeContainer:uniqueId:${containerRecord?.uniqueId()}")
                        Log.d("closeContainer", "--> closeContainer:result:${result}")
                        Log.d("closeContainer", "--> closeContainer:exts:${exts}")
                        containerRecord?.container?.finishContainer(result)
                        Log.d("closeContainer", "--> closeContainer success")
                    }
