...
class STBaseTitleBarWidget extends StatefulWidget {
  ...
  STBaseTitleBarWidget({this.title, this.width = double.infinity, this.height = DEFAULT_TITLE_HEIGHT, this.rightText, this.onBackPressed, this.onRightPressed, this.titleBackgroundColor, this.disableBack = true, Key key}) : super(key: key);

  @override
  createState() => _STBaseTitleBarWidgetState();
}

class _STBaseTitleBarWidgetState extends State<STBaseTitleBarWidget> {
  @override
