<template>
    <div v-bind:style="{ paddingTop: statusBarHeight + 'px',backgroundColor: 'lightgray' }">
        <div class="root">
...
<script>
    ...
    export default {
        data() {
            return {
                statusBarHeight: window.bridge.browser.versions.statusBarHeight,
                name: "test",
                valueName: null,
                msg: "test"
            };
        ...
        beforeCreate: function () {
            ...
            console.log("statusBarHeight:" + window.bridge.browser.versions.statusBarHeight);
