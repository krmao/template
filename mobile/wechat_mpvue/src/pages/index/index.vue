<template>
  <div class="container" @click="clickHandle('test click', $event)">
    ...
    <a href="/pages/blog/main" class="counter">krmao.github.io</a>
    <button v-if="!userInfo.nickName || !userInfo.avatarUrl" class="btn-login" type="primary" open-type="getUserInfo" @getuserinfo="getUserInfo2">授权</button>
  </div>
</template>
