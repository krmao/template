...
import "./basic-monitor-charts-poi-category-note-progress.module.scss";
import ScrollContainerUtil from "@utils/basic-scroll-container-util";
...
const BasicMonitorChartsPoiCategoryNoteProgress = (props) => {
...
export default BasicMonitorChartsPoiCategoryNoteProgress;
