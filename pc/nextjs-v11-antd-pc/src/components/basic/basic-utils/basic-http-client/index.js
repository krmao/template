...
import {APP_REQUEST_BASE_URL} from "../basic-constants-config";
import fetch from "isomorphic-unfetch";

// noinspection JSUnresolvedFunction
const axios = require("axios").create({
    baseURL: APP_REQUEST_BASE_URL(), // `baseURL` 将自动加在 `url` 前面，除非 `url` 是一个绝对 URL,  不设 baseUrl, 则 package.json 里面的 proxy 才会生效, get/post 里面的 url 填写 ip:port 后面的 path
