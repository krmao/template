...
#
# 使用说明:
# >0. 确保电脑已经安装了 python 3.7 下载链接 https://www.python.org/downloads/release/python-374/ 安装后打开控制台 执行 python 成功执行就代表安装成功
# >1. 新建文件夹 workspace
# >2. copy 本脚本到文件夹中
# >3. 将表格另存为 csv 格式并命名为 origin.csv保存到 workspace 文件夹
# >4. 在 workspace 文件夹里面新建 files_old 文件夹
# >5. 执行脚本使用命令: python ./reordername.py
# >6. 重新命名的文件将在新生成的 workspace/files_new 文件夹里面可以找到
#
#                                                                               ---- python 3.7
#                                                                               ---- by smart template
# ======================================================================================================================
