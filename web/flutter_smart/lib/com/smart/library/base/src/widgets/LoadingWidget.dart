...
class LoadingWidget extends StatefulWidget {
    ...
    LoadingWidget({ this.width = DEFAULT_LOADING_WIDTH, this.height = DEFAULT_LOADING_WIDTH, this.isShow = false, Key key}) : super(key: key);
...
class _LoadingState extends State<LoadingWidget> {
    ...
    void _hideLoading({int delay }) => Future.delayed(Duration(milliseconds: delay ?? DEFAULT_LOADING_HIDE_DELAY), () => setState(() => widget.isShow = false));

    @override
    Widget build(BuildContext context) {
        return !widget.isShow ? new Container() : new Container(
