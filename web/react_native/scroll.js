...
import {AppRegistry, ScrollView, StyleSheet, Text, ToastAndroid, TouchableHighlight} from "react-native";
...
export default class ApiComponent extends React.PureComponent {
    ...
    _testPollution = () => {
        ...
        ToastAndroid.clickCount = ToastAndroid.clickCount + 1;
